<div class="container-fluid">
	...
	<form method="post" action="<?php echo base_url('administrator/kegiatan/proses') ?>">
		...
		<div class="form-group">
			...
			<input type="text " name="kode_kegiatan" value="<?=@$kegiatan->kode_kegiatan?>" placeholder="Masukkan Kode Kegiatan" class="form-control">
			<?php echo form_error('kode_kegiatan', ' <div class="text-danger small" ml-3>' )?>
		</div>
